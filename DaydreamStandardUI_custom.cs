...
public class DaydreamStandardUI_custom : ShaderGUI
{
	static private class Styles
	{
		...
		static public GUIContent m_rimLightGC   = new GUIContent("Rim Light", "Enable rim lightong.");
		static public GUIContent m_LightEmissionGC   = new GUIContent("Light Emission", "Enable light emission.");
	...
	public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
	{
		...
		//Rim & Emission CAULDRON.pt
		toggleFeature("RIM_LIGHT", Styles.m_rimLightGC,   targetMats);
		toggleFeature("LIGHT_EMISSION", Styles.m_LightEmissionGC,   targetMats);
