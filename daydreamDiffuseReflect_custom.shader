...
Shader "Daydream/DiffuseAndReflectionsCustom"
{
	Properties
	{
		...
		_Emissive("Emissive", Range(-1.0,1.0)) = 0.0
        ...
        [Header(Rim Light)]
        [Space]
		_RimColor ("Rim Color", Color) = (0,0.8344827,1,1)
		...
		[HDR]_Emissiontintcolor("Emission color", Color) = (0,0,0,1)
	}
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature LIGHT_EMISSION

			#include "daydreamDiffuseReflectInclude_custom.cginc"
	...
	CustomEditor "DaydreamStandardUI_custom"
}
